    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
          <ul>
            <li><a href="<?php echo U('Index/index'); ?>"><i class="fa fa-home fa-fw"></i>主页</a></li>
			<li><a href="<?php echo U('Blog/blog'); ?>" class="active"><i class="fa fa-users fa-fw"></i>博文</a></li>
            <li><a href="<?php echo U('Feeling/feeling'); ?>"><i class="fa fa-users fa-fw"></i>心情</a></li>
			<li><a href="<?php echo U('Gallery/gallery'); ?>"><i class="fa fa-users fa-fw"></i>图集</a></li>
            <li><a href="<?php echo U('Maps/maps'); ?>"><i class="fa fa-map-marker fa-fw"></i>Maps</a></li>
            <li><a href="<?php echo U('Manage/manage'); ?>" ><i class="fa fa-users fa-fw"></i>Manage Users</a></li>
            <li><a href="<?php echo U('Set/set'); ?>"><i class="fa fa-sliders fa-fw"></i>Preferences</a></li>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <p>请在下面详细填写博文内容</p>
            <form action="<?php echo U('Blog/add'); ?>" class="templatemo-login-form" method="post" enctype="multipart/form-data">
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputFirstName">标题</label>
                    <input type="text" class="form-control" id="inputFirstName" name="title" placeholder="Title">                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputLastName">标签</label>
                    <input type="text" class="form-control" id="inputLastName" name="tag" placeholder="Tag">                  
                </div> 
              </div>
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputUsername">点赞数</label>
                    <input type="text" class="form-control" id="inputUsername" name="dianzan" placeholder="Nice">                  
                </div>
              ...
              <div class="row form-group">
                <div class="col-lg-12 has-success form-group">                  
                    ...
                    <input type="text" class="form-control" id="inputWithSuccess" name="keyword" placeholder="Keyword">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-lg-12 form-group">                   
                    ...
                    <textarea class="form-control" id="inputNote" name="content" rows="3" placeholder="Content"></textarea>
                </div>
              </div>
                ...
                <div class="col-lg-6 col-md-6 form-group">
                  <div>
                    ...
                    <div class="templatemo-block margin-bottom-5">
                      <input type="radio" name="is_show" id="r1" value="1" checked>
                      <label for="r1" class="font-weight-400"><span></span>显示</label>
                    </div>
                    <div class="templatemo-block margin-bottom-5">
                      <input type="radio" name="is_show" id="r2" value="0">
