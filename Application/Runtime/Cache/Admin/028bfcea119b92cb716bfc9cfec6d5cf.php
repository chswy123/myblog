    ...
    $(function(){
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
              ...
              <table class="table table-striped table-bordered templatemo-user-table">
				...
				<?php foreach($info as $v){ ?>
                  <tr>
                    ...
                    <td><a href="<?php echo U('Blog/del').'?id='.$v['id']; ?>" class="templatemo-del-btn">删除</a></td>
                  </tr>
               <?php } ?>
          ...
          <div><!-- <div class="templatemo-flex-row flex-content-row"> -->
            <div><!-- <div class="templatemo-content-widget white-bg col-1"> -->
            <!-- <i class="fa fa-times"></i>  <!--删除按钮--> -->
                123  <div id="Pagination" ><?php echo $pageStr; ?></div>  
            </div>
