          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li><a href="<?php echo U('Blog/add'); ?>" class="active">添加博文</a></li>
              ...
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr>
                    ...
                    <td><a href="" class="white-text templatemo-sort-by">关键词<span class="caret"></span></a></td>
                    <td><a href="" class="white-text templatemo-sort-by">标签<span class="caret"></span></a></td>
                    <td><a href="" class="white-text templatemo-sort-by">添加时间<span class="caret"></span></a></td>
					<td><a href="" class="white-text templatemo-sort-by">点赞数<span class="caret"></span></a></td>
					<td><a href="" class="white-text templatemo-sort-by">缩略图<span class="caret"></span></a></td>
					<td><a href="" class="white-text templatemo-sort-by">是否显示<span class="caret"></span></a></td>
                    <td>Edit</td>
                    <td>Action</td>
                    <td>Delete</td>
                  </tr>
