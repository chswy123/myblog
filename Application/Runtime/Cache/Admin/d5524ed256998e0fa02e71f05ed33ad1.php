    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            <li><a href="<?php echo U('Index/index'); ?>"><i class="fa fa-home fa-fw"></i>Dashboard</a></li>
            <li><a href="<?php echo U('Data/data'); ?>"><i class="fa fa-bar-chart fa-fw"></i>Charts</a></li>
            <li><a href="<?php echo U('Data/data'); ?>" class="active" ><i class="fa fa-database fa-fw"></i>Data Visualization</a></li>
