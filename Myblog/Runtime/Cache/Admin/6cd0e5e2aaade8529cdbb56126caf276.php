          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li><a href="<?php echo U('Gallery/add'); ?>" class="active">添加图片</a></li>
              ...
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr>
                    ...
                    <td><a href="" class="white-text templatemo-sort-by">图片路径<span class="caret"></span></a></td>
                    <td><a href="" class="white-text templatemo-sort-by">缩略图路径<span class="caret"></span></a></td>
                    <td><a href="" class="white-text templatemo-sort-by">上传时间<span class="caret"></span></a></td>
                ...
                <?php foreach($info as $v){ ?>
                  <tr>
                    ...
                    <td><a href="<?php echo U('Gallery/edit').'?id='.$v['id']; ?>" class="templatemo-edit-btn">编辑</a></td>
