...
<body>
	...
	<div class="header">
		<div class="container">
			<div class="navbar-header">
				<a class="navbar-brand" href="index.html"><img src="/Myblog/Home/Common/images/logo.png" alt=""></a>
			</div>	
	...
	<div class="banner">
		<!-- banner-text Slider starts Here -->
				<!--<script src="/Myblog/Home/Common/js/responsiveslides.min.js"></script>-->
				 <script>
	...
	<div class="banner-bottom">
		<div class="container">
			...
			<!-- <div class="row"> -->
				...
				<!-- <div class="col-md-4 bb-grids">
					<a href="singlepage.html" class="thumbnail">
					  <img src="/Myblog/Home/Common/images/img5.jpg" alt="">
					</a>
				</div> -->
				<!-- <div class="col-md-4 bb-grids">
					<a href="singlepage.html" class="thumbnail">
					  <img src="/Myblog/Home/Common/images/img6.jpg" alt="">
					</a>
				</div> -->
				<!-- <div class="clearfix"> </div> -->
			<!-- </div> -->
	...
	<!--			<div class="col-sm-6 col-md-4 featur-grids">
					<div class="thumbnail feature-thmbnl">
						...
						<img src="/Myblog/Home/Common/images/img8.jpg" alt="">
						<div class="caption">
				...
				<div class="col-sm-6 col-md-4 featur-grids">
					<div class="thumbnail feature-thmbnl">
						<h4>Gilla frinreet</h4>
						<img src="/Myblog/Home/Common/images/img9.jpg" alt="">
						<div class="caption">
							<h5><a href="singlepage.html">Aliquam erat volutpat<a></h5>
							<p>Donec vitae tellus non sem vulputate cursus. Aliquam erat volutpat. Proin ut est et sem rhoncus fringilla laoreet</p>
							<a href="singlepage.html" class="btn btn-primary hvr-rectangle-in">Read More</a>
